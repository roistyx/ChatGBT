...
const mockFeed = {
  ...
  mockFeed: [
    ...
    {
      title: "Blender Bites Announces Historic Number of Purchase Orders",
    ...
    },
    {
      ...
      banner_image: "https://images.mktw.net/im-833616?width=700&height=321",
      source: "MarketWatch",
    ...
    {
      title: "Chevron  ( CVX )  to Fund Two Low-Carbon Projects in Australia",
    ...
    {
      title: "Verizon ushers in more relief to Maui as wildfires rage",
    ...
    {
      title: "Target Expands Starbucks Food and Drink Curbside Pickup Service",
    ...
    {
      title: "The Trade Desk  ( TTD )  Q2 Earnings and Revenues Top Estimates",
    ...
    {
      title: "Target  ( TGT )  Launches Nationwide Starbucks Drive-Up Service",
    ...
    {
      title: "Amazon Stock: 1 Simple Reason to Buy and Hold 'Forever'",
